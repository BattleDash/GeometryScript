...
#define LOG_INFO() GeometryScript::Log::message(GeometryScript::Log::Level::info)
#define LOG_ERROR() GeometryScript::Log::message(GeometryScript::Log::Level::error)
#define LOG_WARN() GeometryScript::Log::message(GeometryScript::Log::Level::warning)
#define LOG_DEBUG() GeometryScript::Log::message(GeometryScript::Log::Level::debug)

namespace GeometryScript::Log
{
	enum class Level
	{
		info = 3,
